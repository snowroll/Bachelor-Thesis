...
var filePath = path.resolve('/Users/chaihj15/Desktop/Data/test_data/test')  //解析需要遍历的文件夹
var savePath = '/Users/chaihj15/Desktop/Data/test_data/ast/'
                    ...
                    if(eror){
                        ...
                        if(isFile){  // 对代码进行ast 语法分析，重构转换
                            ...
                            if(re_code == null){
                                ...
                                fs.writeFile('failed_file.txt', filename, { flag: 'a+' }, function(err){
                                    if(err){
...
/*
// 单个文件执行ast变换
var signle_file = '/Users/chaihj15/Desktop/Data/test_data/1.txt';
